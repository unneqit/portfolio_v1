...
for (var i = 0; i < projectsItem.length; i++) {
  projectsItem[i].addEventListener('mouseover', function () {
    projectsNav.classList.add('--is-active');
  });
  projectsItem[i].addEventListener('mouseout', function () {
